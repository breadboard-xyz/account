...
mongodb.use(app, auth_middleware);
docusign.use(app, auth_middleware);
...
app.put('/account/:id/secret/', ipfilter_middleware, (req, res, next) => {
  var id = req.params['id'];
...
app.delete('/account/:id/secret/:hash', ipfilter_middleware, (req, res, next) => {
  var id    = req.params['id']
